...
class TileProvider extends TileLayer
{
    ...
    private static $_providers = [
        ...
        'HERE' => [
            ...
            'options' => [
                ...
                'subdomains' => '1234',
                'mapID' => 'newest',
                'app_id' => '', //  Yii::$app->params['leaflet']['providers']['HERE']['app_id']
                'app_code' => '', //  Yii::$app->params['leaflet']['providers']['HERE']['app_code']
                'base' => 'base',
                'variant' => 'normal.day',
                'maxZoom' => 20
            ],
     ...
     * Constructor
     *
     * @param string $name The name of the tile provider
     * @param array $config Additional configuration for the provider and
     * tile layer
     */
    ...
    public function init()
    {
        ...
        $this->url = self::$_providers[$name[0]]['url'];
        $this->options = self::$_providers[$name[0]]['options'];
        ...
        if (isset($name[1])) {
            ...
            $variant = self::$_providers[$name[0]]['variants'][$name[1]];
